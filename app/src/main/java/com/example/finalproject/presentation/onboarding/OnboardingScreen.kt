...
import com.example.finalproject.presentation.designsystem.components.OnboardingButton
import com.example.finalproject.presentation.designsystem.components.OnboardingIndicator
import com.example.finalproject.presentation.login.LoginViewModel
    ...
    Scaffold(bottomBar = {
        Row(
            ...
            Box(modifier = Modifier.weight(1f),
                ...
                OnboardingButton (text = buttonState.value[0],
            ...
            Box(modifier = Modifier.weight(1f),
                ...
                OnboardingIndicator(pageSize = pages.size, currentPage = pagerState.currentPage)
            }
